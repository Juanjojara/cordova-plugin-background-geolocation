...
public class LocationUpdateService extends Service implements LocationListener {
    ...
    */
    ...
    private void postNotification(String info, String loc){
        ...
        shareLocBuilder.addAction(android.R.drawable.ic_stat_dismiss, "Discard", piDismiss);
        shareLocBuilder.addAction(android.R.drawable.ic_stat_snooze, "Confirm", piSnooze);
